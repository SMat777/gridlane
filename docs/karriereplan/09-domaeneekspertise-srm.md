...
| 7-8 | Coupas cXML-materiale plus IAF CertSearch-dokumentationen | — | 5 |
...
| IAF CertSearch API ([iafcertsearch.org/services/api-certificate-search](https://www.iafcertsearch.org/services/api-certificate-search)) | 1 | 2 t | Beviset for at udløbsdato ikke er sandhed: alarmer ved suspension og tilbagetrækning markedsføres som noget andet end udløb. Notér dækningshullerne |
